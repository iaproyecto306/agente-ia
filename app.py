...
# --- NUEVA FUNCIÓN: ACCESO A EMPLEADOS ---
...
traducciones = {
    ...
    "Português": {
        ...
        "desc10": "Acesso via API", "t3_3": "Conecte nossa IA diretamente com seu próprio software o CRM.",
    ...
    "Français": {
        ...
        "desc6": "Optimización SEO", "t2_3": "Textos estructurés pour apparaître en premier dans les moteurs de recherche.",
                ...
                if user_input or url_input: 
                    with st.spinner("Analizando mercado y redactando..."):
                        ...
                        if "ERROR_TECNICO" not in resultado:
                            ...
                            # <--- INCISIÓN 3: GUARDAR HISTORIAL Y VISUALIZACIÓN PROFESIONAL --->
