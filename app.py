...
# --- 2. ESTILOS CSS (AURAS, ANIMACIONES Y BANNER REUPERADOS) ---
st.markdown("""
<style>
    ...
    /* TARJETAS DE PLANES CON AURA Y ANIMACIÓN */
...
# --- 3. DICCIONARIO DE TRADUCCIÓN (TEXTO COMPLETO) ---
...
if "Español" in st.session_state.idioma_selec:
    t = {
        ...
        "p2_name": "Agente Pro", "p2_desc": "<b>Generaciones Ilimitadas</b><br>Pack Redes Sociales (IG/FB)<br>Optimización SEO<br>✨ <b>Aparición en Banner Principal</b>", "p2_btn": "MEJORAR AHORA",
        "p3_name": "Agencia", "p3_desc": "5 Usuarios / Cuentas<br>Panel de Equipo<br>Acceso vía API<br>🔥 <b>Prioridad en Banner Publicitario</b>", "p3_btn": "CONTACTAR VENTAS"
    }
else:
    t = {
        ...
        "p2_name": "Agent Pro", "p2_desc": "<b>Unlimited Generations</b><br>Social Media Pack (IG/FB)<br>SEO Optimization<br>✨ <b>Main Banner Spot</b>", "p2_btn": "UPGRADE NOW",
        "p3_name": "Agency", "p3_desc": "5 Users / Accounts<br>Team Dashboard<br>API Access<br>🔥 <b>Ad Banner Priority</b>", "p3_btn": "CONTACT SALES"
    }
