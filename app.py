...
<style>
    ...
    /* BOTÓN GENERAR: ANIMACIÓN ESPECÍFICA SOLICITADA */
    div.stButton > button[kind="primary"] { 
        background: linear-gradient(90deg, #00d2ff 0%, #0099ff 100%) !important; border: none !important; 
        box-shadow: 0 0 15px rgba(0, 210, 255, 0.4) !important; transition: all 0.3s ease-in-out !important; 
        color: white !important; font-weight: 700 !important; height: 3.2rem !important; width: 100% !important;
    }
    div.stButton > button[kind="primary"]:hover { 
        background: #000000 !important; color: #ffffff !important;
        transform: scale(1.02) !important;
        box-shadow: 0 0 40px rgba(0, 210, 255, 0.9), 0 0 15px rgba(0, 210, 255, 0.6) !important; 
        border: 1px solid #00d2ff !important;
    }

    /* PLANES: IGUALDAD DE ALTURA Y AURA SUAVE */
    .card-wrapper { transition: all 0.5s ease; border-radius: 12px; height: 450px; }
    .card-wrapper:hover { transform: translateY(-10px); }

    .glass-container { background: rgba(38, 39, 48, 0.6); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 12px; padding: 30px; text-align: center; position: relative; height: 100%; }
    
    .free-card { box-shadow: 0 0 25px rgba(255, 255, 255, 0.05); }
    .pro-card { border: 1px solid rgba(0, 210, 255, 0.3) !important; box-shadow: 0 0 30px rgba(0, 210, 255, 0.15); }
    .pro-card:hover { box-shadow: 0 0 50px rgba(0, 210, 255, 0.4); }
    .agency-card { border: 1px solid rgba(221, 160, 221, 0.3) !important; box-shadow: 0 0 30px rgba(221, 160, 221, 0.15); }
    .agency-card:hover { box-shadow: 0 0 50px rgba(221, 160, 221, 0.4); }
    ...
    .feature-list { text-align: left; margin: 25px auto; display: inline-block; font-size: 0.95rem; color: #ccc; line-height: 2.3; }
    ...
    /* CARRUSEL */
    .video-placeholder {
        border: 1px solid rgba(0, 210, 255, 0.2); border-radius: 12px; height: 220px; display: flex; flex-direction: column; align-items: center; justify-content: flex-end;
...
with col_logo: st.markdown('<div style="font-size: 1.5rem; font-weight: 700; color: #fff; margin-top:10px;">🏢 IA REALTY PRO</div>', unsafe_allow_html=True)
with col_lang:
